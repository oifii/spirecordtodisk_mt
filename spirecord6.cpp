        ...
        if (MsgReturn)
        {
            ...
            case SPIRECORD_WMMSG_RECORDING_EXECUTE:
				...
				while(totalrecordedtime_s<totalrecordingtime_s)
				{
					...
					//reset recording frame index
					inuse_pWavSet->frameIndex=0;
					//open stream
					global_err = Pa_OpenStream(
								...
								recordCallback, //NULL, // no callback, use blocking API 
